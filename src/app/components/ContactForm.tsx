...
const ContactForm = () => {
    ...
    return (
      <div className="relative w-full py-10 px-2 lg:px-10">
        ...
        />
        <div className="relative bg-white bg-opacity-70 p-2 lg:p-14 rounded-xl shadow-2xl flex flex-col md:flex-row gap-12 items-center md:backdrop-blur-lg">
          <div className="md:w-1/2">
            ...
            <div className="text-gray-700 mb-6">
              ...
              <p className="flex items-center gap-2 mt-2">
                <MdPhone className="text-gray-600 flex-shrink-0" size={22} />
