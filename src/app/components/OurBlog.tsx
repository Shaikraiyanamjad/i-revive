                    ...
                    <div key={post.id} className="bg-white rounded-lg shadow-lg overflow-hidden border border-hovershed">
                        ...
                        <div className="p-4">
                            <p className="text-primary text-sm flex justify-between">
                                <span className="flex items-center"><FaRegCalendarAlt className="mr-1" /> {post.date}</span>
                                <span className="flex items-center"><FaRegComment className="mr-1" /> {post.comments} Comments</span>
                            </p>
                            <h3 className="text-3xl font-serif  text-gray-900 mt-4 text-left">{post.title}</h3>
                            <p className="text-gray-600 mt-6 text-lg text-left">{post.description}</p>
                            <button className="mt-4 bg-primary text-white text-left px-4 py-2 rounded-full shadow-md hover:bg-hovershed transition">Read More</button>
                        </div>
                    </div>
                ))}
            </div>
